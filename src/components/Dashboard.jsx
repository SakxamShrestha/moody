    ...
    <div className="min-h-screen bg-gray-100 p-8 text-gray-900">
      ...
      <section className="bg-white p-6 rounded-lg mb-8 shadow-lg">
        ...
        <div className="flex gap-4">
          <button className="bg-green-500 text-white px-4 py-2 rounded">😊 Happy</button>
          <button className="bg-yellow-500 text-white px-4 py-2 rounded">😐 Neutral</button>
          <button className="bg-red-500 text-white px-4 py-2 rounded">😔 Sad</button>
        </div>
      </section>
      ...
      <section className="bg-white p-6 rounded-lg mb-8 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-100 p-4 rounded shadow">
            ...
            <Link to="/journal/1" className="text-blue-600 font-semibold mt-2 block">
              Read More
            </Link>
          </div>
          <div className="bg-gray-100 p-4 rounded shadow">
            ...
            <Link to="/journal/2" className="text-blue-600 font-semibold mt-2 block">
              Read More
            </Link>
          </div>
      ...
      <footer className="text-center">
        <Link to="/new-journal" className="bg-blue-600 text-white px-6 py-3 rounded-lg shadow-lg font-semibold">
